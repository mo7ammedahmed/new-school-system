...
- REST endpoints are introduced for genuine third-party or future mobile clients. Inertia page actions remain internal application interfaces and are not treated as a public integration contract.
