...
export default function EnrollmentShow({ enrollment, canEdit, canDelete }: Props) {
    return (
        <>
            <Head title={`Enrollment: ${enrollment.student.first_name} ${enrollment.student.last_name}`} />
                    ...
                    <CardContent className="space-y-6">
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                            ...
                            <StatCard
                                ...
                                value={<DateCell value={enrollment.enrolled_on} />}
                                trend="up"
                                ...
                                <TabsContent value="info">
                                    <div className="space-y-4">
                                        ...
                                        <div className="space-y-2">
                                            ...
                                            <p className="text-muted-foreground">
                                                {enrollment.student.date_of_birth ? new Date(enrollment.student.date_of_birth).toLocaleDateString() : 'Not specified'}
                                            </p>
                                        </div>
                                        ...
                                        <div className="space-y-2">
                                            ...
                                            <p className="text-muted-foreground">
                                                {enrollment.student.gender ?? 'Not specified'}
                                            </p>
                                        </div>
                                        ...
                                        <div className="space-y-2">
                                            ...
                                            <p className="text-muted-foreground">
                                                {enrollment.student.phone ?? 'Not specified'}
                                            </p>
                                        </div>
                                        ...
                                        <div className="space-y-2">
                                            ...
                                            <p className="text-muted-foreground">
                                                {enrollment.student.email ?? 'Not specified'}
                                            </p>
                                        </div>
                                        ...
                                        <div className="grid grid-cols-2 gap-2">
                                            <div className="border p-3 rounded">
                                                ...
                                                <p className="text-2xl font-bold">
                                                    {enrollment.attendance.present ?? 0}
                                                </p>
                                            </div>
                                            <div className="border p-3 rounded">
                                            ...
                                            <div className="border p-3 rounded">
                                                ...
                                                <p className="text-2xl font-bold">
                                                    {enrollment.attendance.late ?? 0}
                                                </p>
                                            </div>
                                            <div className="border p-3 rounded">
                                                <p className="font-medium">Excused</p>
                                                <p className="text-2xl font-bold">
                                                    {enrollment.attendance.excused ?? 0}
                                                </p>
                                            </div>
                                        </div>
                                        <div className="space-y-4">
                                ...
                                <TabsContent value="assessments">
                                    <div className="space-y-4">
                                        {enrollment.assessments.length > 0 ? (
                                            ...
                                            <p className="text-muted-foreground">No assessments recorded for this enrollment</p>
                                        )}
                                    </div>
                                </TabsContent>
                            </Tabs>
