...
export default function FeeStructureEdit({ school, feeStructure }: Props) {
    const { t } = useT();
    ...
    const handleSubmit = (e: React.FormEvent) => {
        e.preventDefault();
        put(EDIT_URL(school.id, feeStructure.id), {
            onSuccess: () => {
            ...
            <div className="space-y-6 p-6">
                <div className="flex flex-col md:flex-row md:items-center md:justify-between">
                    <h1 className="text-2xl font-semibold">
                        {t('feeStructures.edit', { name: feeStructure.name })}
                    </h1>
                ...
                <Card>
                    <CardHeader>
                        ...
                        <CardDescription>
                            {t('feeStructures.form.editDescription')}
                        </CardDescription>
                    </CardHeader>
                    <CardContent>
