        ...
        <>
            ...
            <div className="space-y-6 p-6">
                <div className="flex flex-col md:flex-row md:items-center md:justify-between">
                    <h1 className="text-2xl font-semibold">Student: {student.name}</h1>
                        ...
                        <div className="space-y-4">
                            <Tabs defaultValue="info">
                                ...
                                <TabsContent value="info">
                                    <div className="space-y-4">
                                        ...
                                        <div className="space-y-2">
                                            ...
                                            <p className="text-muted-foreground">{/* Phone from student record */}</p>
                                        </div>

                                        <div className="space-y-2">
                                            <p className="font-medium">Email:</p>
                                            <p className="text-muted-foreground">{/* Email from student record */}</p>
                                        </div>

                                        <div className="space-y-2">
                                            <p className="font-medium">Address:</p>
                                            <p className="text-muted-foreground">{/* Address from student record */}</p>
                                        </div>
                                            ...
                                            <div className="space-y-2">
                                                {student.enrollments.map((enrollment, index) => (
                                                    <div key={index} className="border p-3 rounded">
                                                        ...
                                                        <p className="text-muted-foreground">{enrollment.class}</p>
                                                        {enrollment.section && (
                                                            <>
                                                                <p className="font-medium">Section:</p>
                                                                <p className="text-muted-foreground">{enrollment.section}</p>
                                                            </>
                                                        )}
                                                    </div>
                                                ))}
                                ...
                                <TabsContent value="attendance">
                                    <div className="space-y-4">
                                        <div className="space-y-2">
                                            <p className="font-medium">Attendance Breakdown:</p>
                                        </div>
                                ...
                                <TabsContent value="snapshots">
                                    <div className="space-y-4">
                                        {student.snapshots.length > 0 ? (
                                            <div className="space-y-2">
                                                {student.snapshots.map((snapshot, index) => (
                                                    <div key={index} className="border p-3 rounded mb-4">
                                                        <p className="font-medium">Term: {snapshot.term}</p>
                                                        <p className="text-sm text-muted-foreground">
                                                            Issued: {new Date(snapshot.issuedAt).toLocaleDateString()}
                                                        </p>
                                                        <div className="mt-2">
                                                        ...
                                                        <div className="mt-2">
                                                            ...
                                                            {snapshot.assessments.length > 0 ? (
                                                                <div className="space-y-1">
                                                                    {snapshot.assessments.map((assessment, idx) => (
                                                                ...
                                                                <p className="text-muted-foreground">No assessments in this snapshot</p>
                                                            )}
                                                        </div>
                                                    </div>
                                                ))}
                                            ...
                                            <p className="text-muted-foreground">No report card snapshots</p>
                                        )}
                                    </div>
                                </TabsContent>
                            </Tabs>
