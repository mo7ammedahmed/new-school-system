...
const cards = {
    ar: [
        {
            icon: MessageCircle,
            title: 'احجز عرضاً تعريفياً',
            text: 'دعنا نفهم احتياج مدرستك ونبني الجولة المناسبة.',
            action: 'طلب عرض',
            href: '/register',
        },
        {
            icon: Mail,
            title: 'راسل فريقنا',
            text: 'للاستفسارات والشراكات، نعود إليكم خلال يوم عمل.',
            action: 'hello@madrasati.sa',
            href: 'mailto:hello@madrasati.sa',
        },
        {
            icon: Phone,
            title: 'تحدث معنا',
            text: 'فريقنا جاهز لمساعدتكم في ساعات العمل السعودية.',
            action: '+966 11 000 0000',
    ...
    en: [
        {
            icon: MessageCircle,
            title: 'Book a demo',
            text: 'Let us understand your school and tailor the right walkthrough.',
        ...
        },
        {
            ...
            text: 'For questions and partnerships, we reply within one business day.',
            action: 'hello@madrasati.sa',
            href: 'mailto:hello@madrasati.sa',
        },
        {
            icon: Phone,
            title: 'Talk to us',
            text: 'Our team is ready during Saudi business hours.',
            action: '+966 11 000 0000',
            href: 'tel:+966110000000',
        },
    ],
            ...
            <section className="mx-auto max-w-7xl px-5 pt-20 pb-24 sm:px-8">
                ...
                <div className="bg-surface-container-low text-on-surface mt-10 flex items-center gap-3 rounded-lg px-6 py-4 text-sm font-bold">
                    ...
                    {isArabic
                        ...
                        : 'Sunday — Thursday, 9:00 AM — 5:00 PM Riyadh time'}
                </div>
            </section>
        </PublicLayout>
    );
